...
public class RitsData implements Parcelable {
    ...
    public static final int RITS_SSID_ID_STOP = 10;
    ...
    public String getFriendlyRitsSSID() {
       return ritsFriendlySSID;
    }

    public void setRitsSSID(String ritsSSID) {
        formatSSIDs(ritsSSID);
    }
    ...
    public void setRitsTruckNumber(String ritsTruckNumber) {
        this.ritsTruckNumber = ritsTruckNumber;
    }
